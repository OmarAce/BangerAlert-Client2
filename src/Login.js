...
const AUTH_URL =
  "https://accounts.spotify.com/authorize?client_id=a8c25ab3bd1e48f6a93154cf69c1d709&response_type=code&redirect_uri=https://bangeralert.netlify.app/&scope=streaming%20user-read-email%20user-read-private%20user-library-read%20user-library-modify%20user-read-playback-state%20user-modify-playback-state"
    ...
    >
      ...
      <Container className="d-flex justify-content-between align-items-center ">
        ...
        <div className="d-flex  align-items-center">
          <Button href={AUTH_URL} className="d-flex align-items-center rounded-pill buttonHover shadow" style={btnStyle}>
      ...
      <Button href={AUTH_URL} className="d-flex rounded-pill mb-5 buttonHover shadow" style={btnStyle}>
